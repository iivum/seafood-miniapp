# Spec: admin-batch-operations

## Purpose

[TBD — see change `v2-visual-redesign` for context. Defines the admin-side batch operations, exports, image upload, and dashboard field extensions used by the internal operations team.]
