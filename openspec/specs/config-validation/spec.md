...
[TBD — see change `sprint2-native-security` for context. Defines startup-time validation of every `@ConfigurationProperties` and masking of sensitive values in diagnostic output.]
