# Spec: admin-ui-modules

## Purpose

[TBD — see change `v2-visual-redesign` for context. Defines the six operational screens of the admin UI (login, dashboard, product list/form, order list/detail) and their per-screen functional behavior.]
