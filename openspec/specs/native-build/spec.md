...
[TBD — see change `sprint2-native-security` for context. Defines the GraalVM Native binary build pipeline: agent-driven metadata capture, reproducible `nativeCompile`, runtime budgets, and the distroless docker-compose deployment.]
